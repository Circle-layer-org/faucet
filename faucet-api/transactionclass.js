...
class transactionSender{    
    ...
    static async cointransaction(_userwallet, _peggyamt, _tokename, _contractaddr){                                
        ...
        try{
            ...
            //console.log("##############################################");
            //console.log("##############################################");            
            var mynonce = isNaN(dblastnonce) ? 0 : dblastnonce;
            ...
            myrawTx['value'] = _peggyamt;                         
            myrawTx['gasLimit'] = (parseInt(process.env.GAS_LIMIT) > 29000) ? parseInt(process.env.GAS_LIMIT) : 30000;
            console.log(">>>> GAS_LIMIT >>>", parseInt(process.env.GAS_LIMIT));
